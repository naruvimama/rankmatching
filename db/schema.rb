...
ActiveRecord::Schema.define(version: 20161210200118) do
  ...
  add_index "memberships", ["member_id", "member_type"], name: "index_memberships_on_member_id_and_member_type", using: :btree
